...
#define ID_AD4858_THROUGHPUT	1000000
#define ID_AD4857_THROUGHPUT	1000000
#define ID_AD4856_THROUGHPUT	 250000
#define ID_AD4855_THROUGHPUT	 250000
#define ID_AD4854_THROUGHPUT	1000000
#define ID_AD4853_THROUGHPUT	1000000
#define ID_AD4852_THROUGHPUT	 250000
...
unsigned axiadc_read(struct axiadc_state *st, unsigned thing)
{
	return 0;
}

void axiadc_write(struct axiadc_state *st, unsigned thing, unsigned val)
{
